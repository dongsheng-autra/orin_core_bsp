...
i2ctransfer -f -y 30 w3@0x6b 0x00 0xF0 0x62  # Default
i2ctransfer -f -y 30 w3@0x6b 0x00 0xF1 0xEA  # Default
...
i2ctransfer -f -y 30 w3@0x6b 0x08 0xA3 0xE4  # TODO
i2ctransfer -f -y 30 w3@0x6b 0x08 0xA4 0xE4  # TODO
